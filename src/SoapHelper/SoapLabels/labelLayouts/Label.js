	...
	return (
		<React.Fragment>
			{layout === "columns" ? (
				...
				>
					<p style={styleFontAlign} className="labelSoapName">
						{soapLabel.name}
					</p>
					<p style={styleAlign} className="labelSoapIngredients">
						{soapLabel.ingredients}
					</p>
					{brand && (
						<p style={styleAlign} className="labelSoapBrand">
							{brand}
						</p>
					)}
					{soapLabel.phrase && (
						<p style={styleAlign} className="labelSoapPhrase">
							{soapLabel.phrase}
						</p>
					)}
					{soapLabel.date && (
						<p className="labelSoapDate">{soapDate}</p>
					)}
				</Grid>
			) : (
				<Grid
				...
				>
					...
					>
						<p className="labelWideRowSoapIngredients">
							{soapLabel.ingredients}
						</p>
						{soapLabel.date && (
							<p className="labelWideRowSoapDate">{soapDate}</p>
						)}
					</Grid>
					<Grid
						item
					...
					>
						{brand && (
							<p className="labelWideRowSoapBrand">{brand}</p>
						)}
						<p style={styleFont} className="labelWideRowSoapName">
							{soapLabel.name}
						</p>
						{soapLabel.phrase && (
							<p className="labelWideRowSoapPhrase">
								{soapLabel.phrase}
							</p>
						)}
					</Grid>
